...
stack: [ 'laravel', 'nextjs', 'php', 'statamic', 'javascript', 'tailwindcss', 'prisma', 'reactjs', 'typescript', 'payloadcms']
---
...
## Bahan pembuatan
    ...
    2 sdm minyak goreng
    1/2 sdt garam
    putih telur untuk merekatkan risoles
    air secukupnya
...
- Untuk membuat adonan kulit, campur tepung terigu, tepung tapioka, dan susu bubuk. Aduk rata. Lalu, masukkan kuning telur dan air secukupnya sampai adonan licin. Saring agar tidak bergerindil.
- Panaskan sedikit minyak. Lalu dadar kulit risoles satu per satu sampai adonan habis.
- Tumis bumbu halus. Masukkan kentang dan wortel. Tambahkan air secukupnya. Masak hingga kentang matang dan air menyusut. Matikan api. Masukkan sosis, daun bawang, dan daun seledri.
- Ambil kulit risolis. Beri isian. Gulung. Celupkan ke putih telur yang sudah dikocok lepas. Gulingkan ke tepung panir. Lakukan sampai sampai habis.
- Panaskan minyak goreng. Goreng risoles sampai kecokelatan. Angkat dan sajikan bersama sambal.
